package org.tc.osgi.bundle.requirement.tracking.repport.module.tracker;
...
import org.tc.osgi.bundle.requirement.tracking.repport.conf.MavenPluginRepportPropertyFile;
...
public class GraphBuilderServiceTracker extends ServiceTracker {
    ...
    private String getCoreReqTrackDependencyBundleName() throws FieldTrackingAssignementException {
        if (coreTraqReqDependencyBundleName == null) {
            UtilsServiceProxy.getInstance().getXMLPropertyFile(MavenPluginRepportPropertyFile.getInstance().getXMLFile()).fieldTraking(this, "coreTraqReqDependencyBundleName");
        }
